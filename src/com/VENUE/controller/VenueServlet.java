		...
		if (action.indexOf("getOneVenue_For_Display") != -1) {
			...
			try {
				...
				if (!venueErrorMsgs.isEmpty()) {
					RequestDispatcher failureView = request.getRequestDispatcher("/back-end/VENUE/listAllVenue.jsp");
				...
				RequestDispatcher successView = request.getRequestDispatcher("/back-end/VENUE/listOneVenue.jsp");
			...
			try {
				...
				if (!venueErrorMsgs.isEmpty()) {
					RequestDispatcher failureView = request.getRequestDispatcher("/back-end/VENUE/updateVenue.jsp");
					failureView.forward(request, response);
					return;
				}
				...
				/******************************* 3.查詢完成,準備轉交 **************************************************/
				request.setAttribute("venueVO", venueVO);
				RequestDispatcher successView = request.getRequestDispatcher("/back-end/VENUE/updateVenue.jsp");
				successView.forward(request, response);
