...
public class NoticeChangeMessageSend {
  ...
  try {
      ...
      String messageBig5 = new String(message.getBytes(),"utf8"); //簡訊內容
 ...
 public static void main(String[] args) {
 	NoticeChangeMessageSend se = new NoticeChangeMessageSend();
 	String[] tel ={"0910686272", "0910686272", "0910686272"};
 	String message = "嘿嘿嘿嘿嘿嘿嘿嘿嘿嘿嘿嘿嘿嘿嘿";
