...
<body>
    ...
    <jsp:include page="/front-end/EVENT_TITLE/listEventTitle_ByCompositeQuery.jsp" flush="true" />
    ...
    <!-- JavaScript in File -->
    <script src="<%=request.getContextPath()%>/front-end/EVENT_TITLE/js/selectEventTitle.js"></script>
    <script> 
