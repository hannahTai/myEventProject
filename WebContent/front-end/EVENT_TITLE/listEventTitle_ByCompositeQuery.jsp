        ...
        <div class="row flex-row">
            <c:forEach var="eventTitleVO" items="${listEventTitle_ByCompositeQuery}">
                <div class="col-xs-12 col-sm-4">
                    <div class="thumbnail">
                        <a href="<%= request.getContextPath()%>/front-end/EVENT_TITLE/listOneEventTitle.jsp?evetit_no=${eventTitleVO.evetit_no}" target="_blank">
                        ...
                        <div class="caption">
                            ...
                            <h4><a href="<%= request.getContextPath()%>/front-end/EVENT_TITLE/listOneEventTitle.jsp?evetit_no=${eventTitleVO.evetit_no}" target="_blank">
