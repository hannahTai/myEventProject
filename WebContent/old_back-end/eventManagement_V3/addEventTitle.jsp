...
<head>
    ...
    <!-- JQuery UI CSS -->
    <link rel="stylesheet" href="<%=request.getContextPath() %>/css/jquery_ui_themes/jquery_ui_1103_themes_smoothness.css" />
</head>
...
<body>
    ...
    <!-- ckEditor JS -->
    <script src="<%=request.getContextPath() %>/js/custom_ckeditor_full/ckeditor.js"></script>
    <script src="<%=request.getContextPath() %>js/EMcustomCKEditor.js"></script>
    <!-- JQuery UI JS -->
    <script src="<%=request.getContextPath() %>/js/jquery_ui_master/widgets/datepicker.js"></script>
    <!-- JavaScript in File -->
    <script src="js/addEventTitle.js"></script>
    <!-- JavaScript in HTML -->
